...
def run(ids_path,
    ...
    if external_rhea == True:
        logging.info("Externally querying Rhea database for identifiers not found locally...")
    ...
    if get_related_chebis == True:
        logging.info("Externally querying ChEBI database to add unspecified R-group containing compounds...")
